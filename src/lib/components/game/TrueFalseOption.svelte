...
<button
	class="group relative flex h-28 w-40 cursor-pointer flex-col items-center justify-center rounded-2xl border-[3px] font-arcade text-lg font-bold transition-all duration-300 max-md:h-24 max-md:w-36 max-md:text-base
