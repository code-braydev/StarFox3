...
<button
	class="group relative flex h-24 w-24 cursor-pointer items-center justify-center rounded-xl border-[3px] transition-all duration-300 max-md:h-20 max-md:w-20
		...
		{wasCorrect
		? 'border-amber-400 bg-gradient-to-br from-amber-600 to-orange-800 shadow-[0_0_30px_rgba(245,158,11,0.5)]'
		: wasWrong
...
>
	...
	<!-- Chispas al acertar -->
	{#if wasCorrect}
		<div class="absolute inset-0 animate-pulse rounded-xl bg-amber-400/15"></div>
